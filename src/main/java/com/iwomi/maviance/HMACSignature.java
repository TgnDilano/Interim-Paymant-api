...
public class HMACSignature {
    ...
    public HMACSignature(String method, String url, List<Pair> params) {
        this.method = method;
        this.url = url;
        this.params = params;
    }
     ...
     */
    public static String percentageEncode(String s) {
        try {
     ...
     */
    public static String calculateHMACInBase64(String data, String key) {
